<template>
    <div style="padding-top: 40px;">
        <div style="color: rgb(51, 51, 51);font-family: PingFang SC;font-size: 18px;font-weight: 500;line-height: 27px;letter-spacing: 0px;text-align: left; margin-bottom: 30px;">用户管理</div>
        <div m-b-6>
            <a-radio-group v-model:value="mode" @change="test">
                <a-radio-button value="already">首字母排序</a-radio-button>
                <a-radio-button value="not" style="margin-left: 8px;">权限排序</a-radio-button>
            </a-radio-group>
            <a-button type="primary" float-right>新增用户</a-button>
        </div>
        <a-spin tip="Loading..." :spinning="false">
            <a-row>
                <a-col :span="1">col-12</a-col>
                <a-col :span="23">col-12</a-col>
            </a-row>
        </a-spin>
